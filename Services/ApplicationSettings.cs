...
namespace JabbR.Services
{
    public class ApplicationSettings : IApplicationSettings
    {
        ...
        //Marioz
        public string DeploymentSha { get; set; }
        public string DeploymentBranch { get; set; }
        public string DeploymentTime { get; set; }

        public bool EnableAutomaticAnswering { get; set; }
        public int RequiredAnswerAccuracy { get; set; }
        public string SendAnswerAs { get; set; }
