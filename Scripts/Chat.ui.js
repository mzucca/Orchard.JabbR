...
(function ($, window, document, chat, utility, emoji, moment) {
    ...
    function toggleRichness($element, roomName) {
        ...
        if (blockRichness) {
            $element.addClass('fa-sticky-note-o');
        }
        else {
            $element.removeClass('fa-sticky-note-o');
        }
    }
    function toggleToast($element, enabled) {

        $element.removeClass('fa-flag-checkered');
        if (enabled) {
            $element.addClass('fa-flag-checkered');
        }
    }

    function toggleSound($element, roomName) {
        var value = roomName ? getRoomPreference(roomName, 'hasSound') : preferences['hasSound'];
    ...
    function loadRoomPreferences(roomName) {
        ...
        toggleSound($sound, roomName);
        toggleToast($toast, roomName);
        var enabled = roomName ? getRoomPreference(roomName, 'canToast') : preferences['canToast'];
        toggleRichness($richness, enabled);
    }
    ...
    var ui = {
        ...
        initialize: function (state) {
            ...
            $sound.click(function () {
                ...
                toggleSound($sound, room.getName());
            });
            ...
            $richness.click(function () {
                ...
                toggleRichness($richness, room.getName());
            ...
            $toast.click(function () {
                ...
                if (!enabled) {
                    ...
                    setRoomPreference(room.getName(), false);
                }
                else {
                    toast.enableToast()
                    .done(function () {
