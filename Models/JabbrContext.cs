...
namespace JabbR.Models
{
    public class JabbrContext : DbContext
    {
        ...
        public JabbrContext(IShellSettingsManager settingsManager)
        //: base("Jabbr")
        {
            this.Database.Connection.ConnectionString = settingsManager.LoadSettings().First().DataConnectionString;
            ((IObjectContextAdapter)this).ObjectContext.ObjectMaterialized += OnObjectContextObjectMaterialized;
        }
